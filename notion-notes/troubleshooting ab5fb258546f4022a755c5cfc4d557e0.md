...
This may be a problem with case sensitive filenames. Please refer to [this section](deployment.md#resolving-heroku-deployment-errors).
...
```
import moment from 'moment';import 'moment/locale/fr';
```
...
```
import moment from 'moment';import 'moment/locale/fr';import 'moment/locale/es';// ...moment.locale('fr');
```
