...
> When editing the browserslist config, you may notice that your changes don’t get picked up right away. This is due to an issue in babel-loader not detecting the change in your package.json. A quick solution is to delete the node\_modules/.cache folder and try again.
