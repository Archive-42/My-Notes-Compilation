...
My flashcard database in Anki format: <https://ankiweb.net/shared/info/25173560> (thanks <span class="citation" data-cites="xiewenya">\[@xiewenya\]</span>(https://github.com/xiewenya)).
...
- \[ \] Scalability:
  ...
  - \[ \] Twitter:
    - [O’Reilly MySQL CE 2011: Jeremy Cole, “Big and Small Data at <span class="citation" data-cites="Twitter">@Twitter</span>” (video)](https://www.youtube.com/watch?v=5cKTP36HVgI)
...
sed ‘s/.<span class="math inline">$//' \# assumes that all lines end with CR/LF sed 's/^M$</span>//’ \# in bash/tcsh, press Ctrl-V then Ctrl-M sed ‘s/0D$//’ \# gsed 3.02.80, but top script is easier

# IN UNIX ENVIRONMENT: convert Unix newlines (LF) to DOS format

sed "s/<span class="math inline">$/\`echo -e \\\\\\r\`/" \# command line under ksh sed 's/$</span>‘“/`echo \\\r`/” \# command line under bash sed "s/<span class="math inline">$/\`echo \\\\\\r\`/" \# command line under zsh sed 's/$</span>/’ \# gsed 3.02.80
...
sed -e :a -e ‘s/^.{1,77}<span class="math inline">$/ & /;ta' \# method 1 sed -e :a -e 's/^.\\{1,77\\}$</span>/ &/;ta’ -e ‘s/( \*)\\1/\\1/’ \# method 2
...
sed ‘1!G;h;<span class="math inline">$!d' \# method 1 sed -n '1!G;h;$</span>p’ \# method 2
...
sed ‘<span class="math inline">$!d' \# method 1 sed -n '$</span>p’ \# method 2
...
sed -e ‘/./{H;<span class="math inline">$!d;}' -e 'x;/AAA/b' -e '/BBB/b' -e '/CCC/b' -e d gsed '/./{H;$</span>!d;};x;/AAA|BBB|CCC/b;d’ \# GNU sed only
...
sed ‘/./,/^<span class="math inline">$/!d' \# method 1, allows 0 blanks at top, 1 at EOF sed '/^$</span>/N;/$/D’ \# method 2, allows 1 blank at top, 0 at EOF
...
sed -e :a -e ‘/^<span class="math inline">$/{$</span>d;N;ba’ -e ‘}’ \# works on all seds sed -e :a -e ‘/^<span class="math inline">$/N;/\\n$</span>/ba’ \# ditto, except for gsed 3.02\*
...
echo <span class="citation" data-cites="echo">@echo</span> off &gt;zipup.bat dir /b \_.txt | sed “s/^(.\_).TXT/pkzip -mo \\1 \\1.TXT/” &gt;&gt;zipup.bat
